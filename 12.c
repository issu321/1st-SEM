//Program 12.10: to read, display and add two n x n matrices using functions.
#include <stdio.h>
#include <conio.h>
#define MAX 10
...
void addMatrix(int m, int n, int mat1[MAX][MAX], int mat2[MAX][MAX], int result[MAX][MAX]);
{
    for (int i = 0; i < m; i++)
        for (int j = 0; j < n; j++)
